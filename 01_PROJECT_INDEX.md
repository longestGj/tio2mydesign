...
| 页面体系 | 目录 |
|---|---|
| Home | [当前Manifest V1.5](pages/home/HOME-001_CURRENT_GATE_BASELINE_MANIFEST_V1.5.md)：用户明确决定Mobile Menu透明背景不修改，该共享Finding已关闭；当前仅由D16既有`01My开发1`移除Home Hero左侧绿色竖线，交回后定向复验。五个Application子路由及Sulfate Process路由404仍属Integration开放项；Gate 10及发布未授权。 |
