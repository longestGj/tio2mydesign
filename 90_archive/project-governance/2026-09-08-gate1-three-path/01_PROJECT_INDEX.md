...
总控编排当前入口：[角色V0.5](agents/project-orchestrator/agent.md)及[生效与身份V1.4](docs/architecture/PROJECT_ORCHESTRATOR_ACTIVATION_V1.4.md)。用于状态恢复、准入、派发、接收、异常及关闭；按当前交接合同派发新Gate 5审查与Gate 6差异路径。
...
| Germany当前页面任务 | [当前Manifest V0.12](pages/markets/germany/MARKET-EU-DE_CURRENT_GATE_BASELINE_MANIFEST_V0.12.md)：Gate 1–4/6 `APPROVED / CLOSED`；已交给`00my开发2`，`HANDED_OFF / GATE8_DEVELOPMENT_IN_PROGRESS`。 |
| Italy当前页面任务 | [当前Manifest V0.12](pages/markets/italy/MARKET-EU-IT_CURRENT_GATE_BASELINE_MANIFEST_V0.12.md)：Gate 1–4/6 `APPROVED / CLOSED`；已交给`00my开发2`，`HANDED_OFF / GATE8_DEVELOPMENT_IN_PROGRESS`。 |
...
| Brazil EN/PT当前页面任务 | 两页Gate9首轮均`NOT_PASS`。[EN Manifest V0.14](pages/markets/brazil/MARKET-BR-EN_CURRENT_GATE_BASELINE_MANIFEST_V0.14.md) / [EN验收](pages/markets/brazil/07_qa/MARKET-BR-EN_GATE9_READ_ONLY_ACCEPTANCE_V0.1.md)：完整视觉、四个下游404及RFQ历史恢复Finding开放。[PT Manifest V0.14](pages/markets/brazil/MARKET-BR-PT_CURRENT_GATE_BASELINE_MANIFEST_V0.14.md) / [PT验收](pages/markets/brazil/07_qa/MARKET-BR-PT_GATE9_READ_ONLY_ACCEPTANCE_V0.1.md)：四个下游404及同一RFQ历史恢复Finding开放，`PROVISIONAL_ROUTE`保持。Gate10、部署和发布未授权。 |
...
| RES-CHEMOURS当前页面任务 | [当前Manifest V0.20](pages/resources/chemours-alternatives/RES-CHEMOURS_CURRENT_GATE_BASELINE_MANIFEST_V0.20.md)：Gate 1–6 `APPROVED / CLOSED`；已交给`00my开发2`，`HANDED_OFF / GATE8_DEVELOPMENT_IN_PROGRESS`。 |
| Chloride Process当前页面任务 | Gate9首轮`NOT_PASS / CHANGES_AND_EVIDENCE_REQUIRED`：[当前Manifest V0.27](pages/products/chloride-process/PRODUCT-PROC-CL_CURRENT_GATE_BASELINE_MANIFEST_V0.27.md) / [验收V0.1](pages/products/chloride-process/07_qa/PRODUCT-PROC-CL_GATE9_READ_ONLY_ACCEPTANCE_V0.1.md)。Schema、Applications route、无障碍环境和负向数据/cache/scope共四项Finding开放；八Grade关系和页面视觉已通过。Gate10、部署和发布未授权。 |
| Sulfate Process当前页面任务 | [当前Manifest V0.12](pages/products/sulfate-process/PRODUCT-PROC-SU_CURRENT_GATE_BASELINE_MANIFEST_V0.12.md)：Gate1–4及Gate6 **APPROVED / CLOSED**；已交给`00my开发2`，`HANDED_OFF / GATE8_DEVELOPMENT_IN_PROGRESS`。 |
...
- RES-R706当前基线：[RES-R706_CURRENT_GATE_BASELINE_MANIFEST_V0.8.md](pages/resources/r706-alternative/RES-R706_CURRENT_GATE_BASELINE_MANIFEST_V0.8.md)；Gate 6 V0.2定向修订/复验通过并关闭，现已交给`00my开发2`，`HANDED_OFF / GATE8_DEVELOPMENT_IN_PROGRESS`。

- RES-CHEMOURS当前基线：[RES-CHEMOURS_CURRENT_GATE_BASELINE_MANIFEST_V0.20.md](pages/resources/chemours-alternatives/RES-CHEMOURS_CURRENT_GATE_BASELINE_MANIFEST_V0.20.md)；Gate 6 V0.2定向修订/复验通过并关闭，现已交给`00my开发2`，`HANDED_OFF / GATE8_DEVELOPMENT_IN_PROGRESS`。

- RES-TRADE-EU当前基线：[RES-TRADE-EU_CURRENT_GATE_BASELINE_MANIFEST_V0.9.md](pages/resources/eu-trade/RES-TRADE-EU_CURRENT_GATE_BASELINE_MANIFEST_V0.9.md)；Gate 9首审`NOT_PASS`，等待`G9-T4A5-F02`返修及开放证据。

- RES-TRADE-UK当前基线：[RES-TRADE-UK_CURRENT_GATE_BASELINE_MANIFEST_V0.10.md](pages/resources/uk-trade/RES-TRADE-UK_CURRENT_GATE_BASELINE_MANIFEST_V0.10.md)；Gate 9首审`NOT_PASS / REPAIR_IN_PROGRESS`；F04失效HMRC来源的新目标已按[维护决定V0.1](pages/resources/uk-trade/05_review/RES-TRADE-UK_DEAD_SOURCE_URL_MAINTENANCE_DECISION_V0.1.md)批准实施，F02及开放证据保持。

- RES-TRADE-BR当前基线：[RES-TRADE-BR_CURRENT_GATE_BASELINE_MANIFEST_V0.11.md](pages/resources/brazil-trade/RES-TRADE-BR_CURRENT_GATE_BASELINE_MANIFEST_V0.11.md)；Gate 9首审`NOT_PASS`，等待`G9-T4A5-F02/F03`返修及开放证据。

- RES-TRADE-IN当前基线：[RES-TRADE-IN_CURRENT_GATE_BASELINE_MANIFEST_V0.9.md](pages/resources/india-trade/RES-TRADE-IN_CURRENT_GATE_BASELINE_MANIFEST_V0.9.md)；Gate 9首审`NOT_PASS`，等待`G9-T4A5-F02`返修及开放证据。

- APP-COAT当前基线：[APP-COAT_CURRENT_GATE_BASELINE_MANIFEST_V0.11.md](pages/applications/coatings/APP-COAT_CURRENT_GATE_BASELINE_MANIFEST_V0.11.md)；Gate 9首审`NOT_PASS`；按批准组合恢复`PROVISIONAL_URL`，等待`G9-T4A5-F01/F02`返修及开放证据。

- APP-PLAS当前基线：[APP-PLAS_CURRENT_GATE_BASELINE_MANIFEST_V0.11.md](pages/applications/plastics/APP-PLAS_CURRENT_GATE_BASELINE_MANIFEST_V0.11.md)；Gate 9首审`NOT_PASS / PROVISIONAL_URL`，等待`G9-T4A5-F01/F02`返修及开放证据。

- APP-MB当前基线：[APP-MB_CURRENT_GATE_BASELINE_MANIFEST_V0.12.md](pages/applications/masterbatch/APP-MB_CURRENT_GATE_BASELINE_MANIFEST_V0.12.md)；Gate 9首审`NOT_PASS / PROVISIONAL_URL`，等待`G9-T4A5-F01/F02`返修及开放证据。

- APP-INK当前基线：[APP-INK_CURRENT_GATE_BASELINE_MANIFEST_V0.8.md](pages/applications/printing-inks/APP-INK_CURRENT_GATE_BASELINE_MANIFEST_V0.8.md)；Gate 9首审`NOT_PASS / PROVISIONAL_URL`，等待`G9-T4A5-F01/F02`返修及开放证据。

- APP-PAPER当前基线：[APP-PAPER_CURRENT_GATE_BASELINE_MANIFEST_V0.10.md](pages/applications/paper/APP-PAPER_CURRENT_GATE_BASELINE_MANIFEST_V0.10.md)；Gate 9首审`NOT_PASS / PROVISIONAL_URL`，等待`G9-T4A5-F01/F02`返修及开放证据。

Trade 4 + Application 5 Gate 9当前入口：[首轮独立验收与返修控制V1.0](docs/architecture/GATE9_TRADE4_APPLICATION5_INITIAL_ACCEPTANCE_AND_RETURN_V1.0.md) / [121 AC + 66依赖机器审计V1.0](docs/architecture/GATE9_TRADE4_APPLICATION5_ACCEPTANCE_AUDIT_V1.0.json) / [返修授权与派发V1.0](docs/architecture/GATE9_TRADE4_APPLICATION5_REPAIR_AUTHORIZATION_AND_DISPATCH_V1.0.md)。九页均为`INITIAL_REVIEW_COMPLETE / NOT_PASS / REPAIR_IN_PROGRESS`，Gate 9未关闭。
...
内链专项当前入口：[Agent V0.2](agents/internal-link-review/agent.md)＋[Skill V0.2](skills/internal-link-verification/SKILL.md)＋[生效与交接合同](docs/architecture/INTERNAL_LINK_REVIEW_ACTIVATION_V1.1.md)。规划/运行核对，不新增Gate；项目源未注册，未执行全站实测。
