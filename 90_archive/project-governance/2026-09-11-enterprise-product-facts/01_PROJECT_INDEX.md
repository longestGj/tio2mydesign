...
总控编排当前入口：[角色V0.8](agents/project-orchestrator/agent.md)及[生效与身份V1.7](docs/architecture/PROJECT_ORCHESTRATOR_ACTIVATION_V1.7.md)。用于状态恢复、准入、派发、接收、异常及关闭；按当前交接合同派发新Gate 5审查与Gate 6差异路径。
