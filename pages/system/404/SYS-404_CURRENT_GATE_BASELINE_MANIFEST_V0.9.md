# SYS-404 Current Gate Baseline Manifest V0.9
...
| Gate 0–4 | `APPROVED / CLOSED`; exact combination inherited from [V0.8](SYS-404_CURRENT_GATE_BASELINE_MANIFEST_V0.8.md), SHA-256 `CFD8E433282FB4460E42CDE37BD0060D1112AE353DDC1A427751BC82C2BED242` |
| Gate 6 | `USER_AUTHORIZED / IN_PROGRESS`; dispatch `G6-SYS404-EXEC-20260908-01`; `FAST_PATH`; execution and different-identity independent review required |
...
| Gate 5→6 input | [SYS-404_GATE4_TO_GATE6_HANDOFF_V0.1.md](05_review/SYS-404_GATE4_TO_GATE6_HANDOFF_V0.1.md), SHA-256 `3ECE0FD94FCDD604391E50A989CBDDA7FA92FD049835EB5A2CC773B78947C02E` |
...
No independently indexable `/404/`; real unknown URL delivery remains Gate 8/9.
