...
| Poland当前页面任务 | [当前Manifest V0.24](pages/markets/poland/MARKET-EU-PL_CURRENT_GATE_BASELINE_MANIFEST_V0.24.md)；[PL-G9-RECHECK-03](pages/markets/poland/07_qa/MARKET-EU-PL_GATE9_TARGETED_RECHECK_V0.3.md)：E03缩放图像缺口关闭，E02当前本地接线已验；F03菜单末尾RFQ可见焦点待修，真实账户/接收及Applications依赖保持。Gate1–4/6批准不变，Gate9未关闭，Gate10未授权。 |
