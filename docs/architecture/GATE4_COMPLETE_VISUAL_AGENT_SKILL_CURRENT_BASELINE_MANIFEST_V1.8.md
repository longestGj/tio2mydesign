# Gate 4 Complete Visual Agent / Skill 当前基线 Manifest V1.8
...
| 执行Agent | [Gate 4完整视觉设计与验证Agent](../../agents/gate4-complete-visual/agent.md) V1.4 | `3dc109e0c6c5da6cade1f5265038b3b3b0de72ab8248c2693c8d45f227061709` | `APPROVED_ROLE_SOURCE / NOT_RUNTIME_REGISTERED` |
...
## Gate 4 → 新Gate 5交接当前绑定

本版由双方共用交接合同补齐当前工作流和共同工作合同的接口映射；旧“待切换”说明为历史语境。Gate 5承接同一次最终独立审查，保持现有生命周期记账，不新增批准轮次。

| 对象 | 当前源 | SHA-256 |
|---|---|---|
| 新Gate 5 Agent V0.3 | [新Gate 5 Agent V0.3](../../agents/gate5-independent-visual-review/agent.md) | `7d2dda60ddb2e662943a91464abb3c08bd862c3c8104f348a2f9369edd9d9d62` |
| 共用交接合同 V1.0 | [共用交接合同 V1.0](GATE4_GATE5_VISUAL_HANDOFF_CONTRACT_V1.0.md) | `1b9005b4a375f0551f64549b86bf8bc42476b352af1601e5c6b8b59005466370` |

详细变化见[交接统一记录](GATE4_GATE5_HANDOFF_ALIGNMENT_CHANGE_V1.0.md)。方法源不变，历史页面不重新制作或审查。
