...
| Gate 3 Agent与方法 | [当前基线Manifest V1.12](docs/architecture/GATE3_AGENT_SKILL_CURRENT_BASELINE_MANIFEST_V1.12.md)：Agent V0.6、线框Skill V0.5、核验通用入口V0.8及Gate 3专项V0.3、交接V0.4。承接任务指定批准视觉基准，记录适用范围和继承差异；保持Gate 4完整视觉职责，未进行新版真实页面试跑。 |
