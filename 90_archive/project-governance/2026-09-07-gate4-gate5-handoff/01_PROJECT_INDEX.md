...
| Gate 6策划总审与开发交付 | [当前基线V1.0](docs/architecture/GATE6_AGENT_SKILL_CURRENT_BASELINE_MANIFEST_V1.0.md)：Agent V0.6、两项Skill V0.3；有效上游继承、触发式扩大检查、单一自检、新包独立复核、总控维护Manifest。 |
