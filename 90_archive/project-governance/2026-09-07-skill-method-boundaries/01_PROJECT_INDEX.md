...
总控编排当前入口：[角色V0.1](agents/project-orchestrator/agent.md)及[生效与身份V1.0](docs/architecture/PROJECT_ORCHESTRATOR_ACTIVATION_V1.0.md)。用于状态恢复、准入、派发、接收、异常及关闭；不新增Gate 4 Reviewer或Gate 6执行路径。
...
| Gate 4完整视觉Agent与方法 | [当前基线Manifest V1.3](docs/architecture/GATE4_COMPLETE_VISUAL_AGENT_SKILL_CURRENT_BASELINE_MANIFEST_V1.6.md)：一个[完整视觉执行Agent](agents/gate4-complete-visual/agent.md)，三项能力Skill及[共同工作合同](docs/architecture/GATE4_COMPLETE_VISUAL_AGENT_SKILL_CONTRACT_V1.1.md)。4A为内部方向检查，4B冻结后进入唯一最终独立审查环节；旧Gate 4/5角色与成果保留历史。Belgium仍暂停，本次设计批准不恢复页面执行。 |
| Gate 6 Agent与方法设计 | [当前角色V0.5](agents/gate6-review-delivery/agent.md)＋[一致性核验V0.2](skills/page-contract-consistency-review/SKILL.md)＋[交付规格V0.2](skills/development-delivery-specification/SKILL.md)：继承有效上游、字段级差异、关闭对象、完整原型源/依赖及Gate8适配、稳定验收ID。[三页经验修订与有限验证](docs/superpowers/specs/2026-09-07-gate6-three-page-method-revision-v0.2.md)记录方法身份；[四页实战控制](docs/architecture/GATE6_FOUR_PAGE_PRACTICE_CONTROL_V0.1.md)与[输出核验](docs/architecture/GATE6_FOUR_PAGE_PRACTICE_VERIFICATION_V0.1.md)记录Brazil EN/PT、DOC-COO、Chloride Process草案。页面包待独立复核；不新增外发、开发或运行注册权限。 |
...
| Gate 3 Agent与方法 | [当前基线Manifest V1.10](docs/architecture/GATE3_AGENT_SKILL_CURRENT_BASELINE_MANIFEST_V1.10.md)：[执行角色V0.5](agents/gate3-execution/agent.md)、[线框设计V0.4](skills/responsive-wireframe-design/SKILL.md)、[布局核验V0.7](skills/layout-interaction-verification/SKILL.md)及[交接合同v0.3](docs/superpowers/specs/2026-09-07-gate3-to-gate4-handoff-contract-v0.3.md)。当前V0.5角色/V0.4线框按专项标准限制媒体、动画、风格和返修，未新页面试跑；用户授权范围控制定向修订，标准§4.3为准；[修订与校验记录](docs/superpowers/specs/2026-09-07-gate3-v0.3-scope-targeted-revision.md)。V0.3已在Germany和Italy两个新真实页面完成执行、总控独立审查及用户批准关闭，两页均无阻塞Finding；不扩大其他页面授权。 |
...
| Applications | [pages/applications](pages/applications/)；五篇主Application文章的当前批准状态及后续选题Controller职责见[三篇批准与选题职责记录V0.1](pages/applications/02_analysis/APPLICATION_ARTICLE_TOPIC_CONTROLLER_MANDATE_AND_THREE_ARTICLE_USER_APPROVAL_V0.1.md)；42个候选题材与28个串行研究单元见[选题总计划V0.1](pages/applications/04_planning/APPLICATION_ARTICLE_TOPIC_MASTER_PLAN_V0.1.md)及[详细Backlog V0.1](pages/applications/04_planning/APPLICATION_ARTICLE_TOPIC_BACKLOG_V0.1.csv)；R01修订正文仍待用户批准，见[R01修订正文D23验收V0.2](pages/applications/02_analysis/R01_PVC_UPVC_ARTICLE_D23_ACCEPTANCE_V0.2.md)；用户已另行批准R02 Plastic Film方案，研究与冻结Brief见[R02研究决定V0.1](pages/applications/01_research/r02-plastic-film/R02_RESEARCH_DECISION_V0.1.md)、[R02冻结Brief V1.0](pages/applications/01_research/r02-plastic-film/R02_D22_ARTICLE_BRIEF_V1.0.md)及[R02派发记录V0.1](pages/applications/01_research/r02-plastic-film/R02_D22_DISPATCH_RECORD_V0.1.md) |
