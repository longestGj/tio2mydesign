# CONV-RFQ Current Gate Baseline Manifest V1.2.2
...
This is the only current Gate 1–5 control Manifest for CONV-RFQ. Gate 1 closed after project-control PASS and explicit user confirmation dated 2026-09-01. Gate 2 remains separately `NOT_STARTED / NOT_AUTHORIZED`.
...
1. Project-control P0 layout correction in Review ID `CONV-RFQ-G1-V12-DIRECTED-03` and authoritative user source §11.
...
4. Brief V1.2.2.
5. Gate 1 intent/field/evidence audit V1.2.2.
6. PRODUCT V0.3 and Global Chrome V0.5 within their owned boundaries.
7. Historical V1.2.1, V1.2 and V0.x artifacts for traceability only.

## 3. Current Gate 1–5 baseline

| Gate | Current file/asset | State |
|---|---|---|
| Gate 1 | Brief V1.2.2, Gate 1 audit V1.2.2 and this Manifest | `APPROVED / CLOSED` |
...
Project-control review and user confirmation are complete. This closure does not authorize Gate 2.
...
Gate 1 is `APPROVED / CLOSED`. Stop and wait for separate user authorization in the project-control task before beginning Gate 2.
