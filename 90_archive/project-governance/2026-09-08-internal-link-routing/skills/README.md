...
内链核验：[internal-link-verification V0.1](internal-link-verification/SKILL.md)，用于批准关系与实际链接/落点/买家路径的核对；由内链审查Agent消费。项目源未注册、未全站实测；[生效记录](../docs/architecture/INTERNAL_LINK_REVIEW_ACTIVATION_V1.0.md)。
