...
specs=[('1440',formal/'MARKET-BR-PT_GATE4_1440_FULL_V1.0.png',1600,140,1),('768',formal/'MARKET-BR-PT_GATE4_768_FULL_V1.0.png',1500,140,1),('390',formal/'MARKET-BR-PT_GATE4_390_FULL_V1.0@2x.png',1800,220,2)]
...
payload={'source':{'path':str(root/'MARKET-BR-PT_GATE4_COMPLETE_VISUAL_V1.0.html').replace('\\','/'),'bytes':(root/'MARKET-BR-PT_GATE4_COMPLETE_VISUAL_V1.0.html').stat().st_size,'sha256':sha(root/'MARKET-BR-PT_GATE4_COMPLETE_VISUAL_V1.0.html')},'purpose':'READABLE_LONG_PAGE_STATIC_VISUAL_SUPPORT','segments':segments}
