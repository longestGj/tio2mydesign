# Cookie Policy — Gate 2 Full Copy V0.1
...
| URL | `/cookie-policy/` |
| Date | 2026-09-02 |
| Status | `USER_APPROVED / GATE_2_CLOSED / PRODUCTION_INVENTORY_REQUIRED_BEFORE_RELEASE` |
| Upstream approval | `LEGAL-PRIVACY-G2-SKELETON-PCR-01 = USER_APPROVED / CLOSED` |
