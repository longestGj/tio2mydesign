...
网站采用 Market-First Hybrid Architecture：
...
| 栏目 | 核心职责 |
|---|---|
| Malaysia Origin | 建立真实马来西亚原产、生产、追溯和原产地文件认知 |
...
| Resources | 承载采购指南、技术指南、替代方案和市场贸易更新 |
| About | 说明平台、运营主体和企业背书 |
...
以下内容未纳入 V0.2 的正式需求，将在后续版本逐项讨论并批准：
