...
| 页面体系 | 目录 |
|---|---|
| Home | [当前Manifest V1.2](pages/home/HOME-001_CURRENT_GATE_BASELINE_MANIFEST_V1.2.md)：Applications-aligned Gate 8已交D16既有`01My开发1`并获得可读回执，当前在隔离Home分支/worktree开发；旧Gate 9实现为回退基线，Gate 9/10及发布未授权。 |
