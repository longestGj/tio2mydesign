# APP-MB Gate 2 Full Buyer Clean Copy V0.1
...
Before comparing candidate Grades, check the current TDS and SDS, the relevant lot CoA and application data for the declared masterbatch system. Keep Grade properties, lot conclusions and application-performance claims tied to the document or trial that supports them.

## Plan the next evaluation step

Your team sets the trial plan, sampling, acceptance limits, repeatability requirement and release authority. Use this sequence to decide which question needs an answer before continuing:

| Step | Evidence to assemble | Decision supported |
|---|---|---|
| Document screening | Defined two-stage system, readable applicable documents and a list of missing inputs | Define a controlled concentrate trial |
| Concentrate trial | Method-matched process evidence and the required flow, FPV or morphology observations | Define the receiving-resin and final-specimen trial |
| Receiving-resin and final-specimen trial | Optical, colour, mechanical and end-use or retention evidence for the stated endpoints | Define repeatability work and a release request |
| Repeatability and release decision | Buyer-defined repeatability evidence, unresolved items and the responsible approver | Submit the evidence to the responsible decision owner |

Continuing means only that the evidence supports the next defined evaluation. A release request remains separate from approval. If a required input or comparable result is missing, name it and obtain it before relying on the affected conclusion.
...
- Canonical status: `Candidate only; registered URL remains provisional`
- Language: `en`
- Schema candidates: `WebPage`, `BreadcrumbList`; conditional visible-parity `ItemList`
