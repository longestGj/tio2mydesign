...
日期：2026-09-08。唯一当前权威入口；V0.1完成首次Gate 1用户批准落档，批准内容范围未变。批准前审查组合保留于提交`a8d76b7e3d4e8fa086d8d804eacc646af37e63ac`；Gate 0初始入口保留于提交`4905854dfce72950d1078a82074e950cff298441`及原intake。本Manifest导航当前批准组合，不取代原决定或精确正文来源。
...
| Lifecycle | `APPROVED_FOR_DESIGN`（仅Gate 1研究/方向批准，无后续执行权）；`GATE0_REGISTERED` |
...
本轮四核心已由不同身份独立审查通过，必修0；用户于2026-09-08明确回复“确认。”，`SYS404-G1-USER-20260908-01`关闭本页Gate 1。当前Brief控制字段已同步批准；Research、Execution Submission及原独立审查中的草案/PENDING保留其真实历史时点，不代表当前仍待确认。按原计划，下一允许动作是总控启动CONV-THANK Gate 1，本次同步未启动它。SYS-404 Gate 2及后续没有因本确认获得执行授权。
