...
> 2026-09-07：[Gate工作流V3.5](docs/architecture/GATE_WORKFLOW_V3.5.md)统一阶段解释。原Gate 4/5合并为当前Gate 4；`06_handoff`、`07_qa`及旧Gate 5/7路径保持，不迁移或重命名已批准资料。
...
- 稳定规则：根AGENTS；详细要求：`docs/architecture/PROJECT_GOVERNANCE_DETAILS_V1.6.md`，按触发路由读取。
