...
const htmlPath = path.join(visualDir, 'homepage-root-page-hero-preview-v1.3.html');
const captures = [
  { file: 'HOME-001_ROOT_PAGE_HERO_MOBILE_EDGE_767_CANDIDATE_V1.3.png', width: 767, height: 1400 },
];
const inspections = [
...
(async () => {
  ...
  try {
    ...
    fs.writeFileSync(path.join(visualDir, 'capture-runtime-v1.3.json'), `${JSON.stringify(record, null, 2)}\n`);
