# PRODUCT-000 Gate 7 Handoff Package V0.1
...
2. `PRODUCT-000_GATE5_APPROVED_BASELINE_MANIFEST_V0.2.md` and the exact V0.13/V0.17/V0.16 visual baseline.
3. `PRODUCT-000_GATE6_CURRENT_BASELINE_MANIFEST_V0.1.md`.
4. Historical Gate 6 V0.2 documents for unchanged scope.
5. `PRODUCT-000_SEO_GEO_SCHEMA_CONTRACT_V0.3.md` for the fourteen-summary delta.
6. `PRODUCT_GRADE_APPLICATION_PROCESS_MATRIX_V0.3.csv` and unified audit V0.3.
7. Production SVG Logo Manifest V1.0, Logo Addendum V1.0 and Cross-page Registry V1.0.
8. Page Registry and page-keyword master for Page IDs, registered URLs and ownership.

Historical documents remain traceability records. Stale 25-relation, four-Sulfate, unresolved M-2377 or conditional-Global-Chrome-RFQ language must not override the current baseline.

## 2. Required delivery set

| Deliverable | File |
|---|---|
| Master handoff | `PRODUCT-000_GATE7_HANDOFF_PACKAGE_V0.1.md` |
| CMS/API/component mapping | `PRODUCT-000_GATE7_CMS_API_COMPONENT_MAPPING_V0.1.md` |
| SEO/GEO/Schema/metadata | `PRODUCT-000_GATE7_SEO_GEO_SCHEMA_METADATA_V0.1.md` |
| Responsive/a11y/interaction acceptance | `PRODUCT-000_GATE7_RESPONSIVE_A11Y_INTERACTION_ACCEPTANCE_V0.1.md` |
| Malaysia scope isolation | `PRODUCT-000_GATE7_SITE_SCOPE_ISOLATION_CONTRACT_V0.1.md` |
| Acceptance and blockers | `PRODUCT-000_GATE7_ACCEPTANCE_AND_BLOCKERS_V0.1.md` |
| Handoff Manifest | `PRODUCT-000_GATE7_HANDOFF_MANIFEST_V0.1.md` |
| Project-control submission | `pages/products/05_review/PRODUCT-000_GATE7_PROJECT_CONTROL_REVIEW_SUBMISSION_V0.1.md` |
