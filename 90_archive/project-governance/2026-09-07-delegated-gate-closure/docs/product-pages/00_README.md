...
> 当前未来执行采用[Gate工作流V3.1](../architecture/GATE_WORKFLOW_V3.1.md)、[SOP V2.2](03_Product_Detail_Template_Reuse_Development_SOP_V2.2.md)、[清单V1.2](04_Product_Detail_Single_Grade_Operational_Checklist_V1.2.md)与[Playbook增补V0.3](../page-playbooks/PRODUCT_PLAYBOOK_CURRENT_SOP_ADDENDUM_V0.3.md)。原Gate 4/5合并为Gate 4，原Gate 7交付并入Gate 6。下列旧批准、Review ID、SOP V2.0及封存包均为可追溯历史/有效具体合同，不能据旧流程新建独立Gate 7阶段；实质产品要求保持。

## Historical approval source — 2026-09-02

- `03_Product_Detail_Template_Reuse_Development_SOP_V2.0.md` was approved as `APPROVED_PROJECT_STANDARD / ACTIVE` under `PRODUCT-DETAIL-SOP-V2-USER-APPROVAL-01`.
- `04_Product_Detail_Single_Grade_Operational_Checklist_V1.0.md` was its approved per-Grade checklist; new work uses the current entry above.
...
4. `03_Product_Detail_Template_Reuse_Development_SOP_V2.0.md`
   - Historical approved basis for standard versus fast-track Grade development; current workflow uses V2.2
...
Current authority follows root AGENTS §3 and the page Manifest: latest user decisions → approved specific Brief → approved PRD → keyword master → approved Playbook/specification → valid evidence → research → history. This section does not create a competing precedence order.
