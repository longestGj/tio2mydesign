...
| Gate 3五个Resource串行批次 | [当前串行控制V1.0](docs/architecture/GATE3_FIVE_RESOURCE_SERIAL_CONTROL_V1.0.md)：用户授权对新盘点出的五个Gate2已关闭、Gate3未关闭Resource页使用子代理严格串行执行；当前仅释放RES-R706，后四页排队。 |
