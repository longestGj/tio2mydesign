# CONV-RFQ Gate 1 Intent, Keyword, Field and Evidence Rebase V1.2.2
...
| Directed correction | Project-control P0 return, 2026-09-01 | Controls V1.2.2; restores the source-authorized desktop form-internal two-column Grid |
| Authoritative layout source | User input §11, lines 301–345 | Page remains one standard content flow; Desktop may use a two-column Grid inside the form |
...
- Page remains one standard content flow at 1440, 768 and 390. At 1440, the form itself may use a two-column field Grid; at 768 and 390, fields stack in one column.
- Page-level left/right composition, side rails, independent context rails and Dashboard/SaaS layout remain rejected. These prohibitions do not apply to the desktop form’s internal field Grid.
...
| Field | V1.2.2 decision | Evidence/risk boundary |
|---|---|---|
...
| E03 | Directed V1.2.2 layout correction | User source §11 + project-control P0 return / 2026-09-01 | CURRENT CHANGE DIRECTION / REVIEW REQUIRED |
...
| E08 | Exact success, failure and privacy wording | Frozen from V1.2.1 / 2026-09-01 | CURRENT GATE 1 COPY CONTRACT / UNCHANGED |
...
V1.2.2 passed project-control review and received explicit user confirmation on 2026-09-01. The Gate 1 checkpoint is `CONTENT_INTENT_CONFIRMED / CLOSED`. The source-authorized Desktop two-column field Grid remains inside the page’s single content flow, while Tablet/Mobile remain single-column. Unit vocabulary, phone-field treatment, state copy, privacy/legal dependencies and all other frozen decisions remain unchanged. Gate 2 is not authorized and no visual asset is current.
