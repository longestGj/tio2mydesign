# PRODUCT-000 Gate 7 Responsive / Accessibility / Interaction Acceptance V0.3
...
|---|---|
| 1440px Desktop | Full page, Header/Footer, Hero split, Selector work area, Process route cards 2/1/0 plus CR-901 row, directory 2×2, five Evaluation cards, Support 3/2/1/0, FAQ 1+4 and final RFQ |
...
| Process | Section heading/intro always; 2 equal cards, 1 restrained card or route-card grid 0px; CR-901 row always | Cards may use two columns or stack; CR-901 follows grid | Complete cards stack; at 0 omit card wrapper and close intro directly to CR-901 row |
...
- Conditional Process route-card removal leaves the Process parent section and CR-901 row with one normal internal gap; Support removal and other route-state changes leave one normal section gap, not accumulated blank bands.
...
- [ ] Process route-card 2/1/0 verified with CR-901 row retained in all states; Support 3/2/1/0 closure verified.
