...
> 当前阶段职责见[Gate工作流V2.0](docs/architecture/GATE_WORKFLOW_V3.0.md)：Gate 6总审并交付，原Gate 7并入6；Gate 8负责WordPress＋Next.js技术承接与实现，Gate 9独立只读验收，Gate 10另行发布授权。以下项目事实与页面状态不因此改变。
