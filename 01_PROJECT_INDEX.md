...
| 页面体系 | 目录 |
|---|---|
| Home | [当前Manifest V1.0](pages/home/HOME-001_CURRENT_GATE_BASELINE_MANIFEST_V1.0.md)：Applications-aligned Gate 4已按新Gate 5独立审查链关闭；Gate 6执行中；用户已授权Gate 8由既有`01My开发1`执行，待Gate 6批准包形成后派发。旧Gate 9实现为当前回退基线。 |
