// APP-000 Gate 3 planning source. Buyer copy is derived from approved B; edit B only through its owner.
const fs = require('fs');
...
const sources = {
  manifest: ['pages/applications/APP-000_CURRENT_GATE_BASELINE_MANIFEST_V1.1.md','de27777ca62854af0fd57f59452cbc34b5d4485b038ef2300eaece344fcc4e1f'],
...
const styles=fs.readFileSync(out+'/structure.css','utf8');
