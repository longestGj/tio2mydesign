...
| 页面体系 | 目录 |
|---|---|
| Home | [当前Manifest V1.4](pages/home/HOME-001_CURRENT_GATE_BASELINE_MANIFEST_V1.4.md)：Applications-aligned Gate 9已独立审查并定向退回；共享Mobile Menu缺少批准的背景变暗遮罩，用户另批准移除Home Hero左侧绿色竖线。两项已交D16既有`01My开发1`，五个Application子路由及Sulfate Process路由404仍属Integration开放项；Gate 10及发布未授权。 |
