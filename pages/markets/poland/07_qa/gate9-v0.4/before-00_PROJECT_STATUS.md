...
| MARKET-EU-PL | **READ_ONLY_QA_IN_REVIEW** | [当前Manifest V0.24](pages/markets/poland/MARKET-EU-PL_CURRENT_GATE_BASELINE_MANIFEST_V0.24.md)；[PL-G9-RECHECK-03](pages/markets/poland/07_qa/MARKET-EU-PL_GATE9_TARGETED_RECHECK_V0.3.md)：E03缩放图像缺口关闭，E02当前本地接线已验；F03菜单末尾RFQ可见焦点待修，真实账户/接收及Applications依赖保持。Gate1–4/6批准不变，Gate9未关闭，Gate10未授权。 |
...
| Application后续专题文章 | R02 WRITE已获用户批准；D22完整流程已派发 | R02确定为一篇finished Plastic Film文章，核心为film thickness、TiO2 concentration/distribution、opacity、dispersion defects与process response的关系；PVC/calendered film合并为受控非转移分支，不另写一篇。冻结Brief SHA `270fb8e4...7d1` 已派发到 `00-Con-masterbatch`，要求完整A01→A02→A03独立审查/关闭→A04独立审查/关闭→A05→A06/RQR→A00→Controller closure，并前置Article-vs-SOP约束。R01修订正文批准仍独立待定；R03及后续未启动；[R02研究决定](pages/applications/01_research/r02-plastic-film/R02_RESEARCH_DECISION_V0.1.md) / [冻结Brief](pages/applications/01_research/r02-plastic-film/R02_D22_ARTICLE_BRIEF_V1.0.md) / [派发记录](pages/applications/01_research/r02-plastic-film/R02_D22_DISPATCH_RECORD_V0.1.md) |
