...
| 页面体系 | 目录 |
|---|---|
| Home | [当前Manifest V1.1](pages/home/HOME-001_CURRENT_GATE_BASELINE_MANIFEST_V1.1.md)：Applications-aligned Gate 6唯一开发包已独立复核并按常设授权关闭；用户已授权Gate 8由D16既有`01My开发1`执行，当前等待派发回执。旧Gate 9实现为回退基线。 |
