...
- HOME-001 Gate 6：已提交项目总控审查，入口为 `pages/home/05_review/HOME-001_GATE6_PROJECT_CONTROL_REVIEW_SUBMISSION_V0.1.md`；当前裁决状态为 `PENDING_PROJECT_CONTROL_DECISION`。
- HOME-001 页面生命周期：`DESIGN_IN_REVIEW`；不得提前升级为 `APPROVED_FOR_HANDOFF`，Gate 7 未授权。
...
| HOME-001 首页 Gate 5 | `APPROVED / CLOSED`；Gate 6 已提交 | 用户批准日期 2026-08-31；正式基线为 Desktop V0.7、390px Mobile V0.6.1、Mobile Menu Open V0.6 与 Global Chrome V0.2；页面生命周期仍为 `DESIGN_IN_REVIEW`，Gate 6 待总控裁决，Gate 7 未授权 |
...
| 页面体系 | 数量 | 当前总体状态 |
|---|---:|---|
| Home | 1 | 页面映射批准；Gate 5 已批准关闭；Gate 6 待总控裁决；生命周期 `DESIGN_IN_REVIEW` |
