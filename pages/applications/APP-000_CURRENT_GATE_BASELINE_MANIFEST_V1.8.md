# APP-000 Current Gate Baseline Manifest V1.8

2026-09-08. This is the sole current APP-000 page Manifest. V1.7 and earlier APP-000 Gate 1–5 documents remain immutable history or reference inputs; none is a competing current Manifest. V1.8 records the exact Gate 8 repair return and the start of independent Gate 9 targeted recheck.
...
| Lifecycle | `GATE9_TARGETED_RECHECK_IN_PROGRESS` |
| Current Gate | Gate 9 targeted independent recheck of the repaired candidate |
...
| Gate 8 | `REPAIR_RETURNED / TARGETED_RECHECK_ADMITTED` | Four implementation Findings repaired at `0144b30`; exact evidence HEAD, Build and held runtime passed schema validation and two-round Controller preflight |
| Gate 9 | `TARGETED_RECHECK_IN_PROGRESS` | Original independent reviewers are rechecking F01–F04 and affected acceptance conditions; user retains Gate 9 approval |
