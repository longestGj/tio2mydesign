# RES-TRADE-EU Gate 2 Content Contract V0.1
...
- Written scope: the regulation's defined TiO2 product with at least 80% TiO2 by weight on a dry-matter basis, all particle sizes, originating in the People's Republic of China.
...
- Fixed table: LB Group EUR 0.74/kg (`89CB`); Anhui Gold Star Group EUR 0.25/kg (`89CC`); other cooperating Annex companies EUR 0.64/kg (applicable Annex code); all other PRC-origin imports EUR 0.74/kg (`8999`).
- Individual rates require the regulation's valid commercial invoice; without it the all-other PRC-origin rate applies. Customs can perform further checks.
