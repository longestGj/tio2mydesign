# Gate 3 Eight-page Serial Control V1.0
...
|---:|---|---|---|
| 1 | `MARKET-EU-ES` | `MARKET-EU-ES_CURRENT_GATE_BASELINE_MANIFEST_V0.6.md` | `IN_PROGRESS` |
| 2 | `DOC-COO` | `DOC-COO_CURRENT_GATE_BASELINE_MANIFEST_V0.6.md` | `AUTHORIZED / QUEUED` |
...
Queue item 1, `MARKET-EU-ES`, is released to the Gate 3 execution subagent. All later pages remain authorized but not started.
