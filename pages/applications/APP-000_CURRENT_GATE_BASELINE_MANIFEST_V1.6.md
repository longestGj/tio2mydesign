# APP-000 Current Gate Baseline Manifest V1.6

2026-09-08. This is the sole current APP-000 page Manifest. V1.5 and earlier APP-000 Gate 1–5 documents remain immutable history or reference inputs; none is a competing current Manifest. V1.6 records the material Gate 8 return and the start of independent Gate 9 read-only acceptance.
...
| Lifecycle | `READ_ONLY_QA_IN_PROGRESS` |
| Current Gate | Gate 9 independent read-only acceptance |
...
| Gate 8 | `IMPLEMENTED / RETURNED_FOR_GATE9` | D16 implementation `f0285f2`; evidence HEAD `ce3f4c5`; Build `jf9b1VFzbgKGSQMVOMMbU`; schema and two-round runtime preflight both `PASS` |
| Gate 9 | `STARTED / IN_PROGRESS` | Independent read-only acceptance against `APP000-G9-01…17`; user retains Gate 9 approval |
