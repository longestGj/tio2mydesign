# RES-TRADE-BR Full Buyer Clean Copy V0.1
...
Resolution 850 removed **Siegwerk Druckfarben AG & CO KGAA** from the named producer/exporter list. The MDIC detail page captured for the measure still displays the older name, so do not use that page’s long list without the later resolution. Removal from the list does not, by itself, tell this page which band or treatment applies to a particular shipment.
...
- [Resolution GECEX 850/2026](https://www.gov.br/mdic/pt-br/assuntos/camex/resolucoes/gecex/resolucao-gecex-no-850-de-30-de-janeiro-de-2026) — later removal of Siegwerk from the named producer/exporter list.
