...
const htmlPath = path.join(visualDir, 'homepage-root-page-hero-preview-v1.2.html');
const captures = [
  { file: 'HOME-001_ROOT_PAGE_HERO_TABLET_768_CANDIDATE_V1.2.png', width: 768, height: 1400 },
  { file: 'HOME-001_ROOT_PAGE_HERO_MOBILE_EDGE_767_CANDIDATE_V1.2.png', width: 767, height: 1400 },
  { file: 'HOME-001_ROOT_PAGE_HERO_MOBILE_390_CANDIDATE_V1.2.png', width: 390, height: 1500 },
];
const inspections = [
...
(async () => {
  ...
  try {
    ...
    fs.writeFileSync(path.join(visualDir, 'capture-runtime-v1.2.json'), `${JSON.stringify(record, null, 2)}\n`);
