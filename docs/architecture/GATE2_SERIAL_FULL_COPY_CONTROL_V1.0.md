...
|---|---|---|
| `DOC-COO` | `PROJECT_CONTROL_REVIEW_PASS_PENDING_BATCH_USER_APPROVAL` | `DOC-COO_GATE2_FULL_BUYER_CLEAN_COPY_V0.2.md` |
| `MARKET-EU-NL` | `PROJECT_CONTROL_REVIEW_PASS_PENDING_BATCH_USER_APPROVAL` | `MARKET-EU-NL_GATE2_FULL_BUYER_CLEAN_COPY_V0.2.md` |
| `MARKET-EU-BE` | `PROJECT_CONTROL_REVIEW_PASS_PENDING_BATCH_USER_APPROVAL` | `MARKET-EU-BE_GATE2_FULL_BUYER_CLEAN_COPY_V0.2.md` |
| `MARKET-IN-001` | `PROJECT_CONTROL_REVIEW_PASS_PENDING_BATCH_USER_APPROVAL` | `MARKET-IN-001_GATE2_FULL_BUYER_CLEAN_COPY_V0.1.md` |
| `MARKET-BR-EN` | `PROJECT_CONTROL_REVIEW_PASS_PENDING_BATCH_USER_APPROVAL` | `MARKET-BR-EN_GATE2_FULL_BUYER_CLEAN_COPY_V0.2.md` |
| `MARKET-BR-PT` | `PROJECT_CONTROL_REVIEW_PASS_PENDING_BATCH_USER_APPROVAL` | `MARKET-BR-PT_GATE2_FULL_BUYER_CLEAN_COPY_V0.2.md` |
| `PRODUCT-PROC-SU` | `PROJECT_CONTROL_REVIEW_PASS_PENDING_BATCH_USER_APPROVAL` | `PRODUCT-PROC-SU_GATE2_FULL_BUYER_CLEAN_COPY_V0.2.md` |
| `RES-R706` | `PROJECT_CONTROL_REVIEW_PASS_PENDING_BATCH_USER_APPROVAL` | `RES-R706_GATE2_FULL_BUYER_CLEAN_COPY_V0.3.md` |
| `RES-TRADE-EU` | `PROJECT_CONTROL_REVIEW_PASS_PENDING_BATCH_USER_APPROVAL` | `RES-TRADE-EU_GATE2_FULL_BUYER_CLEAN_COPY_V0.2.md` |
| `RES-TRADE-UK` | `PROJECT_CONTROL_REVIEW_PASS_PENDING_BATCH_USER_APPROVAL` | `RES-TRADE-UK_GATE2_FULL_BUYER_CLEAN_COPY_V0.3.md` |
