...
Choose the single sentence with the weakest naturalness, scanability, parallel structure or professional clarity. Quote it. Either create a Finding or explain specifically why a buyer can still understand it without rereading. A generic statement that the target-language is professional is not sufficient.
