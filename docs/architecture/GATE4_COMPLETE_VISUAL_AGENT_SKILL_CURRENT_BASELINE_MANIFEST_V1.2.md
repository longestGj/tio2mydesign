# Gate 4 Complete Visual Agent / Skill 当前基线 Manifest V1.2

## 1. 当前组合

| 对象 | 当前入口 | SHA-256 | 状态 |
|---|---|---|---|
| 工作流 | [Gate工作流V3.1](GATE_WORKFLOW_V3.1.md) | `0a823c9922b1985526b2c646afa5d9cb1865c13743d2495433e86f94c68894d5` | `APPROVED / ACTIVE` |
...
| 执行Agent | [Gate 4完整视觉设计与验证Agent](../../agents/gate4-complete-visual/agent.md) V1.1 | `b0a0c682cab300131090c484ae4ae0c9e931d7e1648c643f06a4d68948b8d9ab` | `APPROVED_ROLE_SOURCE / NOT_RUNTIME_REGISTERED` |
