...
| Gate 3 执行 Agent | [agent.md](gate3-execution/agent.md) V0.6 | [当前基线Manifest V1.12](../docs/architecture/GATE3_AGENT_SKILL_CURRENT_BASELINE_MANIFEST_V1.12.md)：增加批准视觉基准适用性、继承差异及冲突归属；结构与完整视觉边界保持。 |
