# CONV-RFQ Current Gate Baseline Manifest V1.4
...
| Gate status | `DRAFT_FOR_PROJECT_CONTROL_REVIEW / TARGETED_REVISION` |
...
| 5 | `pages/conversion/request-a-quote/04_planning/CONV-RFQ_GATE2_CONTENT_SKELETON_V1.1.md` | 15,535 | `016E8241AAF4A3C31ED0C8D52504E52AD64D60BA6CAA1173029A548F8B844DEE` | Current targeted Gate 2 skeleton with corrected Hero logic and fixed MT suffix |
| 6 | `pages/conversion/request-a-quote/04_planning/CONV-RFQ_GATE2_SEO_GEO_SCHEMA_DIRECTION_V1.1.md` | 8,256 | `43582BD39200D12CD2E27F232737F4C5BA6197C544C22AC103823D5AFF5D08F2` | Current targeted natural SEO Title/Meta direction |
...
1. Project-control directed return `CONV-RFQ-G2-SKELETON-PCR-01` dated 2026-09-01.
...
5. Gate 2 Content Skeleton V1.1 and SEO/GEO/Schema Direction V1.1.
...
| Gate 2 | Content Skeleton V1.1, SEO/GEO/Schema Direction V1.1 and this Manifest | `DRAFT_FOR_PROJECT_CONTROL_REVIEW / TARGETED_REVISION / SKELETON_CHECKPOINT` |
...
### Superseded initial Gate 2 skeleton package

| File | Bytes | SHA-256 | Disposition |
|---|---:|---|---|
| `pages/conversion/request-a-quote/04_planning/CONV-RFQ_GATE2_CONTENT_SKELETON_V1.0.md` | 15,234 | `C5CD8C02141599882D859BBCE0B01636546F2DCAD9285741F6D784ED04ACF843` | `HISTORICAL / SUPERSEDED_BY_V1.1 / NOT_CURRENT_CONTROL` |
| `pages/conversion/request-a-quote/04_planning/CONV-RFQ_GATE2_SEO_GEO_SCHEMA_DIRECTION_V1.0.md` | 7,930 | `B72D70F2E2FF68387C19276B3A7C6DC9101C37E9A160A58BFA7FF7B1F25ED747` | `HISTORICAL / SUPERSEDED_BY_V1.1 / NOT_CURRENT_CONTROL` |
| `pages/conversion/request-a-quote/04_planning/CONV-RFQ_CURRENT_GATE_BASELINE_MANIFEST_V1.3.md` | 11,996 | `72B89CAA6507CC120DF88FDC0593B2628D91BD5A77DF45646A031B47AA695D07` | `HISTORICAL CONTROL MANIFEST / SUPERSEDED_BY_V1.4` |
| `pages/conversion/request-a-quote/05_review/CONV-RFQ_GATE2_SKELETON_PROJECT_CONTROL_REVIEW_SUBMISSION_V1.0.md` | 7,814 | `47D0D84686FC927F09CBFA61ACECD3E7C2A38A2C1881312171DF900CF61C95BF` | `HISTORICAL RETURNED SUBMISSION / NOT_CURRENT_CONTROL` |
...
| 2026-09-01 | Project control returned three targeted skeleton corrections | Correct Hero required-field logic, natural Title/Meta and fixed static MT suffix only; all other contracts frozen |
...
| O02A | Gate 2 content-skeleton project-control review | REVISION REQUIRED | Targeted re-review under `CONV-RFQ-G2-SKELETON-PCR-01` blocks user skeleton confirmation |
...
Submit Review ID `CONV-RFQ-G2-SKELETON-PCR-01` to project control. Stop at `CONTENT_SKELETON_PENDING_USER_CONFIRMATION / REVISION_REQUIRED`; do not complete full Gate 2 copy or begin Gate 3.
