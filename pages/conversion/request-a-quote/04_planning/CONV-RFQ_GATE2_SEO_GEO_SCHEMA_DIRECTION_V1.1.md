# CONV-RFQ Gate 2 SEO / GEO / Schema Direction V1.1
...
| Visible-content source | `CONV-RFQ_GATE2_CONTENT_SKELETON_V1.1.md` |
...
|---|---|---|
| SEO Title | `Request a Titanium Dioxide Quote | TiO2 Malaysia` | Natural transactional phrasing; no price, stock or manufacturer claim |
| Meta Description | `Request a titanium dioxide quotation from TiO2 Malaysia by providing your grade, application, quantity in metric tonnes and destination for review.` | No response time, availability or commercial outcome |
...
| Surface | Direction |
|---|---|
| Title | Use natural quotation-action wording; the primary keyword remains an ownership record and is not forced as an exact-match phrase |
