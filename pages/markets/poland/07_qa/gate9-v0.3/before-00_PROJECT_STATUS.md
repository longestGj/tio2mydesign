...
| MARKET-EU-PL | Gate 1–4/6 **APPROVED / CLOSED**；**READ_ONLY_QA_IN_REVIEW** | [当前 Manifest V0.23](pages/markets/poland/MARKET-EU-PL_CURRENT_GATE_BASELINE_MANIFEST_V0.23.md)；[PL-G9-RECHECK-02](pages/markets/poland/07_qa/MARKET-EU-PL_GATE9_TARGETED_RECHECK_V0.2.md)：F01/F02复验关闭，E01本地定向隔离已补齐；E02真实接收/环境关联、E03缩放图像证据及Applications开发依赖仍开放。Gate 1–4/6批准保持，Gate 9未关闭，Gate 10未授权。 |
