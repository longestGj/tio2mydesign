# APP-000 Current Gate Baseline Manifest V1.9

2026-09-08. This is the sole current APP-000 page Manifest. V1.8 and earlier APP-000 Gate 1–5 documents remain immutable history or reference inputs; none is a competing current Manifest. V1.9 records the first repair re-review and its bounded F01-R2 return to Gate 8.
...
| Lifecycle | `GATE8_REPAIR_R2_IN_PROGRESS` |
| Current Gate | Gate 8 second targeted repair after Gate 9 residual F01 return |
...
| Gate 8 | `F01_R2_REPAIR_REQUIRED / DISPATCHED` | F02–F04 closed; the first repair left internal identities in a loaded public client chunk and the RFQ public projection |
| Gate 9 | `REPAIR_REREVIEW_COMPLETE / NOT_PASS / AWAITING_R2_RETURN` | Exact repair candidate checked beyond APP HTML/RSC; F01-R2 remains open and user retains Gate 9 approval |
