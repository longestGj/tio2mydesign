...
> 2026-09-07：[Gate工作流V3.4](docs/architecture/GATE_WORKFLOW_V3.4.md)统一阶段解释。原Gate 4/5合并为当前Gate 4；`06_handoff`、`07_qa`及旧Gate 5/7路径保持，不迁移或重命名已批准资料。
...
| `D:\32Wordpress_new` | 当前网站开发：WordPress、CMS、共享组件、代码、测试、部署与实际实现 |
...
- 稳定规则：根AGENTS；详细要求：`docs/architecture/PROJECT_GOVERNANCE_DETAILS_V1.5.md`，按触发路由读取。
...
- [ ] 代码工作只在 `D:\32Wordpress_new` 开发项目中按其项目规则和具体授权进行。
