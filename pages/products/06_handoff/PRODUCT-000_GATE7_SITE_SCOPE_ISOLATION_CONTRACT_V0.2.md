# PRODUCT-000 Gate 7 `site_scope=tio2-my` Isolation Contract V0.2
...
Each link is stored as Page ID/route key and resolved within Malaysia scope. Route state includes at least:
...
Unresolved conditional Process/support cards do not render. Unresolved required Grade, Home or RFQ destinations block release. A working foreign route is not a valid resolution.
