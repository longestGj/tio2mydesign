# CONV-RFQ Current Gate Baseline Manifest V1.7
...
| Review ID | `CONV-RFQ-G2-FULL-COPY-01` |
...
This is the only current Gate 1–5 Manifest. The complete Gate 2 copy has been authored against the user-confirmed skeleton and is pending project-control review. No Gate 3 authority is implied.

## 1. Current authoritative payload

| Priority | File | Bytes | SHA-256 | Authority role |
|---:|---|---:|---|---|
| 1 | `pages/conversion/request-a-quote/05_review/CONV-RFQ_GATE2_HERO_USER_REBASE_PROJECT_CONTROL_CLOSURE_V1.0.md` | 2,116 | `BEE101988724C25F167A06A7C2E828CCE93232407EC49643BC4DE1562FB9EB1E` | Closes the original-Hero governance rebase |
| 2 | `pages/conversion/request-a-quote/04_planning/CONV-RFQ_GATE2_FULL_COPY_V1.0.md` | 15,460 | `F44741D2AA4580FD824DBB521797A22B879556D49EF7918E2F23C99BA77DE003` | Complete Buyer Clean copy and interaction-state wording |
| 3 | `pages/conversion/request-a-quote/04_planning/CONV-RFQ_GATE2_FULL_COPY_VALIDATION_V1.0.md` | 4,550 | `859827843531646011D56CCC355926E2878C9060DFD0299686F1EB800E7E6682` | Content, state, claim, responsive and SEO/GEO/Schema validation |
| 4 | `pages/conversion/request-a-quote/04_planning/CONV-RFQ_GATE2_USER_CONFIRMED_HERO_OVERRIDE_V1.0.md` | 3,867 | `32AD5FDE26FA69101B7E18070DA3F14FE30FF2E02899348A38BC0E952699C393` | Exact original Hero and user confirmation of other skeleton content |
| 5 | `pages/conversion/request-a-quote/04_planning/CONV-RFQ_GATE2_CONTENT_SKELETON_V1.1.md` | 15,535 | `016E8241AAF4A3C31ED0C8D52504E52AD64D60BA6CAA1173029A548F8B844DEE` | Confirmed skeleton except its superseded Hero paragraph |
| 6 | `pages/conversion/request-a-quote/04_planning/CONV-RFQ_GATE2_SEO_GEO_SCHEMA_DIRECTION_V1.1.md` | 8,256 | `43582BD39200D12CD2E27F232737F4C5BA6197C544C22AC103823D5AFF5D08F2` | Confirmed SEO/GEO/Schema direction |
| 7 | `docs/page-briefs/CONV-RFQ_REQUEST_A_QUOTE_BRIEF_V1.2.2.md` | 16,624 | `D0EB8C435616B5EE5DEC43F573D4F0C792421284F836E2D8B6DF4EFEF4A0722F` | Approved Gate 1 page contract |
| 8 | `pages/conversion/request-a-quote/01_research/CONV-RFQ_GATE1_INTENT_FIELD_EVIDENCE_REBASE_V1.2.2.md` | 12,293 | `22F6228DB5589A3A6587A813CE464FB05FB8363B799101E85F52FF7403F7087D` | Approved evidence and relationship audit |
...
| Gate 2 full copy | Full Copy V1.0 + Validation V1.0 | `DRAFT_FOR_PROJECT_CONTROL_REVIEW` |
...
|---|---|---|---|
| G2-COPY | Complete copy and module order review | `OPEN / CONV-RFQ-G2-FULL-COPY-01` | Blocks `FULL_COPY_AND_MODULE_ORDER_CONFIRMED` |
...
| REL-02 | Privacy/legal/cookie and Sample/Documents routes | `PARALLEL / OPEN` | Retained in final target; later verification |
| SEO-ACT | Canonical/robots/Schema activation | `NOT_AUTHORIZED` | Planning only |

Next action: submit `CONV-RFQ-G2-FULL-COPY-01` for project-control review. Stop before Gate 3.
