# Product Detail Gate 7 Global Chrome, Responsive and Accessibility Contract V0.1
...
| RFQ | Fixed across approved Header/Menu/Footer surfaces |
...
Static proof does not validate runtime focus, accessible-tree, zoom, receiver forms, font loading or actual long-content cases. Gate 8 must implement them and Gate 9 must independently inspect them.
