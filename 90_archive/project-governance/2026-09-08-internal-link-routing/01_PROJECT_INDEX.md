...
总控编排当前入口：[角色V0.4](agents/project-orchestrator/agent.md)及[生效与身份V1.3](docs/architecture/PROJECT_ORCHESTRATOR_ACTIVATION_V1.3.md)。用于状态恢复、准入、派发、接收、异常及关闭；按当前交接合同派发新Gate 5审查与Gate 6差异路径。
...
| Germany当前页面任务 | [当前Manifest V0.11](pages/markets/germany/MARKET-EU-DE_CURRENT_GATE_BASELINE_MANIFEST_V0.11.md)：Gate 1–4/6 `APPROVED / CLOSED`；V0.1依赖状态Finding已由V0.2定向修订/复验关闭，最终包`MARKET-EU-DE-G6-HANDOFF-02`；`APPROVED_FOR_HANDOFF / HANDED_OFF=NO`，Gate 8–10未启动。 |
| Italy当前页面任务 | [当前Manifest V0.11](pages/markets/italy/MARKET-EU-IT_CURRENT_GATE_BASELINE_MANIFEST_V0.11.md)：Gate 1–4/6 `APPROVED / CLOSED`；`IT-G4-PC-R01`保持关闭，最终包`MARKET-EU-IT-G6-HANDOFF-01`经不同身份独立复核通过；`APPROVED_FOR_HANDOFF / HANDED_OFF=NO`，Gate 8–10未启动。 |

| Gate 9 Agent与方法改进 | [角色V0.3](agents/gate9-read-only-acceptance/agent.md)＋[运行方法V0.2](skills/runtime-implementation-verification/SKILL.md)＋[配合参考V0.2](skills/runtime-implementation-verification/references/gate9-method-integration.md)：逐控件覆盖、采集有效性、接收分层与定向收口；[实战修订记录](docs/superpowers/specs/2026-09-07-gate9-poland-improvements-v0.1.md)。项目源未运行注册；[Gate8交接清单](D:/16Wordpress_nextjs/docs/d23-gate-handoff.md)已完成[接口独立复核](docs/superpowers/specs/2026-09-07-gate8-handoff-interface-review-v0.1.md)，不改变页面批准。 |
...
| Gate 2执行Agent设计与交付 | 当前项目角色：[agent.md](agents/gate2-execution/agent.md) V0.6；[设计收束V0.7](docs/superpowers/specs/2026-09-06-gate2-execution-agent-design-v0.7.md)与[当前交付结构V0.5](docs/superpowers/specs/2026-09-07-gate2-delivery-structure-v0.5.md)。两步流程与用户批准保持；骨架限于方向判断、同轮集中返修，总控核对范围及跨合同；Buyer冷读必须扫描完整页面，外部公司/品牌/链接/事实触发第三方来源表达精度检查。C仅因动作、事实/来源范围、机器语义、模块职责或条件渲染变化升级；Manifest仅因实质阶段或权威组合变化升级。V0.4保存为Chemours测试基线，未建立Gate 2专属Skill。 |
| Gate 2 Review Agent | 当前项目角色：[agent.md](agents/gate2-review/agent.md) V0.6；[用户批准设计V0.1](docs/superpowers/specs/2026-09-06-gate2-review-agent-design-v0.1.md)与[当前交付结构V0.5](docs/superpowers/specs/2026-09-07-gate2-delivery-structure-v0.5.md)。与总控按V0.5分工，局部复验不重启完整链；Reviewer采用Discovery/Reporting两遍流程，找到一个问题后必须继续到页面末尾；条件性来源审查核对实体、谓词、范围、限定词/日期和链接标签。报告精简但保存全部实质Finding。Reviewer仍不改文案、不授予Gate批准。 |
...
| Spain当前页面任务 | Gate 9二次定向复验完成，**DEPENDENCIES_REMAIN / NOT_PASS**。[当前Manifest V0.19](pages/markets/spain/MARKET-EU-ES_CURRENT_GATE_BASELINE_MANIFEST_V0.19.md)；[Spain复验V0.3](pages/markets/spain/07_qa/MARKET-EU-ES_GATE9_TARGETED_RECHECK_V0.3.md)。F01/F02/F04关闭；F03四个批准目标404仍开放。 |
| India当前页面任务 | Gate 9定向复验完成，**DEPENDENCY_REMAINS / NOT_PASS**。[当前Manifest V0.17](pages/markets/india/MARKET-IN-001_CURRENT_GATE_BASELINE_MANIFEST_V0.17.md)；[复验V0.2](pages/markets/07_qa/MARKET_FOUR_GATE9_TARGETED_RECHECK_V0.2.md)。F02/F03/F04关闭；F01 India Trade目标404开放。 |
| Brazil EN/PT当前页面任务 | [EN当前Manifest V0.13](pages/markets/brazil/MARKET-BR-EN_CURRENT_GATE_BASELINE_MANIFEST_V0.13.md) / [PT当前Manifest V0.13](pages/markets/brazil/MARKET-BR-PT_CURRENT_GATE_BASELINE_MANIFEST_V0.13.md)：两页Gate1–4/6已关闭，现`HANDED_OFF / GATE8_USER_AUTHORIZED`；既有`00Con`已确认`BR-EN-G6-HANDOFF-02`和`BR-PT-G6-HANDOFF-02`，基线审计与开发进行中。[授权](docs/architecture/GATE8_BR_CL_COO_FOUR_PAGE_AUTHORIZATION_AND_DISPATCH_V1.0.md) / [回执](docs/architecture/GATE8_BR_CL_COO_FOUR_PAGE_DISPATCH_RECEIPT_V1.0.json)。实现未回报，Gate9、部署和发布未授权。 |
| DOC-COO当前页面任务 | [当前Manifest V0.16](pages/documents/certificate-of-origin/04_planning/DOC-COO_CURRENT_GATE_BASELINE_MANIFEST_V0.16.md)：Gate1–4/6已关闭，现`HANDED_OFF / GATE8_USER_AUTHORIZED`；`00Con`已确认`COO-G6-HANDOFF-04`，基线审计与开发进行中。RED/GREEN、完整开发身份及`PROVISIONAL_URL / FACT_EVIDENCE_REQUIRED`保持硬合同；Gate9、部署和发布未授权。[回执](docs/architecture/GATE8_BR_CL_COO_FOUR_PAGE_DISPATCH_RECEIPT_V1.0.json)。 |
...
| RES-CHEMOURS当前页面任务 | [当前Manifest V0.19](pages/resources/chemours-alternatives/RES-CHEMOURS_CURRENT_GATE_BASELINE_MANIFEST_V0.19.md)：Gate 1–6 `APPROVED / CLOSED`；V0.1审查ID Finding已由V0.2定向修订/复验关闭，最终包`RES-CHEMOURS-G6-HANDOFF-02`，`APPROVED_FOR_HANDOFF / HANDED_OFF=NO`。 |
| Chloride Process当前页面任务 | [当前Manifest V0.26](pages/products/chloride-process/PRODUCT-PROC-CL_CURRENT_GATE_BASELINE_MANIFEST_V0.26.md)：Gate1–4/6已关闭，现`HANDED_OFF / GATE8_USER_AUTHORIZED`；`00Con`已确认`CL-G6-HANDOFF-03`，基线审计与开发进行中。八Grade稳定Page ID链及开放依赖保持；Gate9、部署和发布未授权。[回执](docs/architecture/GATE8_BR_CL_COO_FOUR_PAGE_DISPATCH_RECEIPT_V1.0.json)。 |
| Sulfate Process当前页面任务 | [当前Manifest V0.11](pages/products/sulfate-process/PRODUCT-PROC-SU_CURRENT_GATE_BASELINE_MANIFEST_V0.11.md)：Gate1–4及Gate6 **APPROVED / CLOSED**；[PRODUCT-PROC-SU-G6-HANDOFF-01](pages/products/sulfate-process/06_handoff/PRODUCT-PROC-SU_GATE6_HANDOFF_PACKAGE_V0.1.md)锁定五模块、五Grade固定顺序、16项Gate9条件和8类依赖；[常设授权关闭记录](pages/products/sulfate-process/05_review/PRODUCT-PROC-SU_GATE6_DELEGATED_APPROVAL_AND_CLOSURE_V0.1.md)。生命周期`APPROVED_FOR_HANDOFF`，未实际外发，Gate8–10未授权。 |
...
| Trade 4 + Application 5 Gate 8派发 | [授权与派发V1.0](docs/architecture/GATE8_TRADE4_APPLICATION5_AUTHORIZATION_AND_DISPATCH_V1.0.md) / [接收回执V1.0](docs/architecture/GATE8_TRADE4_APPLICATION5_DISPATCH_RECEIPT_V1.0.json)：九页已交给`00My开发2`，开发进行中；Brazil只实施当前V0.2包。Gate 9、合并、部署和发布未授权。 |
...
| Applications | [pages/applications](pages/applications/)；五篇主Application文章的当前批准状态及后续选题Controller职责见[三篇批准与选题职责记录V0.1](pages/applications/02_analysis/APPLICATION_ARTICLE_TOPIC_CONTROLLER_MANDATE_AND_THREE_ARTICLE_USER_APPROVAL_V0.1.md)；42个候选题材与28个串行研究单元见[选题总计划V0.1](pages/applications/04_planning/APPLICATION_ARTICLE_TOPIC_MASTER_PLAN_V0.1.md)及[详细Backlog V0.1](pages/applications/04_planning/APPLICATION_ARTICLE_TOPIC_BACKLOG_V0.1.csv)；R03 Powder Coatings精确正文已获用户批准并关闭文章流程，见[R03用户批准与关闭V0.1](pages/applications/02_analysis/R03_POWDER_COATINGS_ARTICLE_USER_APPROVAL_AND_CLOSURE_V0.1.md)、[R03 D23接收V0.1](pages/applications/02_analysis/R03_POWDER_COATINGS_ARTICLE_D23_ACCEPTANCE_V0.1.md)及[最终正文](../22文案写作分析/projects/titanium-dioxide-for-powder-coatings/a05-editing-production/run-01-v1/article-edited.md)；R04及后续未启动。R01修订正文仍待用户批准，见[R01修订正文D23验收V0.2](pages/applications/02_analysis/R01_PVC_UPVC_ARTICLE_D23_ACCEPTANCE_V0.2.md)；R02 Plastic Film完整D22流程、D23验收与用户正文批准均已完成，见[R02用户批准与关闭V0.1](pages/applications/02_analysis/R02_PLASTIC_FILM_ARTICLE_USER_APPROVAL_AND_CLOSURE_V0.1.md)及[R02 D23验收V0.1](pages/applications/02_analysis/R02_PLASTIC_FILM_ARTICLE_D23_ACCEPTANCE_V0.1.md) |
...
- RES-R706当前基线：[RES-R706_CURRENT_GATE_BASELINE_MANIFEST_V0.7.md](pages/resources/r706-alternative/RES-R706_CURRENT_GATE_BASELINE_MANIFEST_V0.7.md)；Gate 6 V0.2定向修订/复验通过并关闭，`APPROVED_FOR_HANDOFF / HANDED_OFF=NO`。

- RES-CHEMOURS当前基线：[RES-CHEMOURS_CURRENT_GATE_BASELINE_MANIFEST_V0.19.md](pages/resources/chemours-alternatives/RES-CHEMOURS_CURRENT_GATE_BASELINE_MANIFEST_V0.19.md)；Gate 6 V0.2定向修订/复验通过并关闭，`APPROVED_FOR_HANDOFF / HANDED_OFF=NO`。

- RES-TRADE-EU当前基线：[RES-TRADE-EU_CURRENT_GATE_BASELINE_MANIFEST_V0.8.md](pages/resources/eu-trade/RES-TRADE-EU_CURRENT_GATE_BASELINE_MANIFEST_V0.8.md)；Gate 1–6关闭，已交给`00My开发2`执行Gate 8；`HANDED_OFF / DEVELOPMENT_IN_PROGRESS`。

- RES-TRADE-UK当前基线：[RES-TRADE-UK_CURRENT_GATE_BASELINE_MANIFEST_V0.8.md](pages/resources/uk-trade/RES-TRADE-UK_CURRENT_GATE_BASELINE_MANIFEST_V0.8.md)；Gate 1–6关闭，已交给`00My开发2`执行Gate 8；`HANDED_OFF / DEVELOPMENT_IN_PROGRESS`。

- RES-TRADE-BR当前基线：[RES-TRADE-BR_CURRENT_GATE_BASELINE_MANIFEST_V0.10.md](pages/resources/brazil-trade/RES-TRADE-BR_CURRENT_GATE_BASELINE_MANIFEST_V0.10.md)；已交给`00My开发2`执行Gate 8，接收检查确认只实施当前V0.2包；`HANDED_OFF / DEVELOPMENT_IN_PROGRESS`。

- RES-TRADE-IN当前基线：[RES-TRADE-IN_CURRENT_GATE_BASELINE_MANIFEST_V0.8.md](pages/resources/india-trade/RES-TRADE-IN_CURRENT_GATE_BASELINE_MANIFEST_V0.8.md)；Gate 1–6关闭，已交给`00My开发2`执行Gate 8；`HANDED_OFF / DEVELOPMENT_IN_PROGRESS`。

- APP-COAT当前基线：[APP-COAT_CURRENT_GATE_BASELINE_MANIFEST_V0.10.md](pages/applications/coatings/APP-COAT_CURRENT_GATE_BASELINE_MANIFEST_V0.10.md)；Gate 1–6关闭，已交给`00My开发2`执行Gate 8；`HANDED_OFF / DEVELOPMENT_IN_PROGRESS`。

- APP-PLAS当前基线：[APP-PLAS_CURRENT_GATE_BASELINE_MANIFEST_V0.10.md](pages/applications/plastics/APP-PLAS_CURRENT_GATE_BASELINE_MANIFEST_V0.10.md)；已交给`00My开发2`执行Gate 8；`PROVISIONAL_URL / HANDED_OFF / DEVELOPMENT_IN_PROGRESS`。

- APP-MB当前基线：[APP-MB_CURRENT_GATE_BASELINE_MANIFEST_V0.11.md](pages/applications/masterbatch/APP-MB_CURRENT_GATE_BASELINE_MANIFEST_V0.11.md)；已交给`00My开发2`执行Gate 8；`PROVISIONAL_URL / HANDED_OFF / DEVELOPMENT_IN_PROGRESS`。

- APP-INK当前基线：[APP-INK_CURRENT_GATE_BASELINE_MANIFEST_V0.7.md](pages/applications/printing-inks/APP-INK_CURRENT_GATE_BASELINE_MANIFEST_V0.7.md)；已交给`00My开发2`执行Gate 8；`PROVISIONAL_URL / HANDED_OFF / DEVELOPMENT_IN_PROGRESS`。

- APP-PAPER当前基线：[APP-PAPER_CURRENT_GATE_BASELINE_MANIFEST_V0.9.md](pages/applications/paper/APP-PAPER_CURRENT_GATE_BASELINE_MANIFEST_V0.9.md)；已交给`00My开发2`执行Gate 8；`PROVISIONAL_URL / HANDED_OFF / DEVELOPMENT_IN_PROGRESS`。
...
内链专项当前入口：[Agent V0.1](agents/internal-link-review/agent.md)＋[Skill V0.1](skills/internal-link-verification/SKILL.md)＋[生效与交接合同](docs/architecture/INTERNAL_LINK_REVIEW_ACTIVATION_V1.0.md)。规划/运行核对，不新增Gate；项目源未注册，未执行全站实测。
