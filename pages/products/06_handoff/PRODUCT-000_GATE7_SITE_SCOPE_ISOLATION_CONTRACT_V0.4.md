# PRODUCT-000 Gate 7 `site_scope=tio2-my` Isolation Contract V0.4
...
| Gate 8 | `HANDED_OFF_TO_EXTERNAL_DEVELOPMENT / AUTHORIZED`; external execution status maintained by D16 |
| Fixed scope | `tio2-my` |
...
2. all fourteen Grade links and all three conditional Chloride/Sulfate Process route-card states: 2, 1 and 0;
