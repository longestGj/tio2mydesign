...
总控入口：[Website Planning Orchestrator V0.14](project-orchestrator/agent.md)，由当前根任务承担；[批准、生效及精确身份](../docs/architecture/PROJECT_ORCHESTRATOR_ACTIVATION_V1.15.md)。配套SOP、交接合同和Gate路由在角色中链接；不是新增上级任务或运行注册。
...
Gate 8不设独立Agent；开发及Gate 9接收读取[当前规则](../docs/architecture/GATE8_CURRENT_RULES_V1.0.md)及[Gate 9基线V1.2](../docs/architecture/GATE9_AGENT_SKILL_CURRENT_BASELINE_MANIFEST_V1.2.md)。旧D16队列及CMS/scope说明只用于原合同对象。
