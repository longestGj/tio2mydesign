...
Gate 3/4/6常设关闭保留独立审查与必修关闭。1/2/9/10保留原批准规则；关闭、下一阶段执行、外发和发布各自按授权。未实施的新Gate 4 Reviewer、Gate 6 FAST_PATH及共享工具仍是提案，不从本包推导已经可用。

## 3. 当前角色身份

| 文件 | SHA-256 |
|---|---|
| [agent.md](../../agents/project-orchestrator/agent.md) | `dba8fda597af3fcc4da594ca651a0753dcfac2e8ed2655c7bd2942fcd478113d` |
...
| [gate-routing.md](../../agents/project-orchestrator/references/gate-routing.md) | `b296dfd3765670cf8876173c3fd5c4dc589c591bf37f20dcf17db38ee6fe022d` |
