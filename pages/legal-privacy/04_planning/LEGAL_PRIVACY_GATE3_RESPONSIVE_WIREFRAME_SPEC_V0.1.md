# Legal / Privacy Gate 3 Responsive Wireframe Specification V0.1
...
| Field | Value |
|---|---|
| Document ID | `LEGAL-PRIVACY-G3-WIREFRAME-01` |
...
| Gate 3 authorization | `USER_AUTHORIZED / ACTIVE` |
...
- Long-form policy content uses a narrow reading column with a sticky-capable table-of-contents rail.
