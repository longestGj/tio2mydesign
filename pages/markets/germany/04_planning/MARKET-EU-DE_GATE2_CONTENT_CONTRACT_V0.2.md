# MARKET-EU-DE Gate 2 Content Contract V0.2
...
| Visible-copy authority | The B file selected by the current `MARKET-EU-DE` page Manifest; only content between `BUYER_COPY_START` and `BUYER_COPY_END` |
