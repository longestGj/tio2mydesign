...
Date: 2026-09-07. Control ID: `G4-13PAGE-BATCH4-01`. Status: `BATCH_1_IN_PROGRESS / STOP_AFTER_BATCH_1`.
...
|---:|---:|---|---|---|
| 1 | 1 | `MARKET-EU-DE` | Gate 3 closed | Gate 4 executor active |
| 1 | 2 | `MARKET-EU-IT` | Gate 3 closed | Gate 4 executor active |
| 1 | 3 | `APP-COAT` | Gate 3 closed | Gate 4 executor active |
| 1 | 4 | `APP-PLAS` | Gate 3 closed | Same-batch queued; start at first free child slot |
