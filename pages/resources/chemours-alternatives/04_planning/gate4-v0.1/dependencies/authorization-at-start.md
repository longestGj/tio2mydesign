...
Date: 2026-09-07. Control ID: `G4-REMAINING-8-EXEC-01`. Status: `BATCH_1_IN_PROGRESS`.
...
|---:|---:|---|---|
| 1 | 1 | `RES-CHEMOURS` | `IN_PROGRESS` |
| 1 | 2 | `RES-TRADE-EU` | `IN_PROGRESS` |
| 1 | 3 | `APP-MB` | `IN_PROGRESS` |
| 1 | 4 | `RES-TRADE-UK` | `QUEUED_SAME_BATCH` |
| 2 | 5 | `RES-TRADE-IN` | `QUEUED` |
| 2 | 6 | `RES-TRADE-BR` | `QUEUED` |
| 2 | 7 | `APP-INK` | `QUEUED` |
| 2 | 8 | `APP-PAPER` | `QUEUED_SAME_BATCH` |
