...
| RES-TRADE-EU | Gate 2 `USER_APPROVED / CLOSED`；Gate 3 `IN_PROGRESS` | 串行队列当前唯一释放页；[当前Manifest V0.4](pages/resources/eu-trade/RES-TRADE-EU_CURRENT_GATE_BASELINE_MANIFEST_V0.4.md)。Regulation 2025/4、Notice C/2026/4533及实体/发票边界保持；时效事实仍受30天/事件触发复核约束 |
